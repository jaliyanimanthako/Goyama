...
Data augmentation is performed to increase the diversity of the training dataset and improve the model's robustness. The augmentation script is located in `src/data_augmentation.py`.
